...
function Footer() {
  ...
  const toggleFooter = () => {
    setFooterCollapsed(!isFooterCollapsed);
  };
  ...
  return (
    <footer className="footer-wrapper">
      <div className="container">
        ...
        {/* {+} */}
        {/* <div className="footer-collapsible-button" onClick={toggleFooter}>
          {isFooterCollapsed ? "Show Links" : "Hide Links"}
        </div> */}
        <div
          className={`footer-links-wrapper row ${
